...
This test computes the last few primes below 2<sup>64</sup>. It is the worst case for the given prime window size. Smaller primes will compute faster.
